...
export const tagVariants = cva(
    'transition-all break-all py-1 border inline-flex items-center text-sm pl-2 rounded-md',
    {
        variants: {
            variant: {
        ...
        <span
            ...
            className={cn(
                ...
                }),
                {
                    ...
                    'pr-2': tagObj.old,
                    'bg-[#49d849]': (tagObj.is_complete || !tagObj.old) && !tagObj.is_checkin,
                    'hover:!bg-[#49d849]': (tagObj.is_complete || !tagObj.old) && !tagObj.is_checkin,
